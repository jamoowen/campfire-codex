  ...
  return (
    <section className="hero" aria-labelledby="hero-title">
      <picture className="hero__art">
        ...
        />
        <img
          src="/assets/campfire-party-1440.webp"
          alt=""
          width="1920"
          height="1343"
        />
      ...
      <div className="hero__content shell">
        ...
        <p className="hero__lede">
          Search chefs, ingredients, cuisines and weeknight shortcuts. Save the
          promising ones. Mark the survivors cooked. Judge them mercilessly.
        </p>
